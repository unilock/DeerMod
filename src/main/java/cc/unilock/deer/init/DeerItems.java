...
import cc.unilock.deer.item.SolidGoldDeerArtifactItem;
...
public class DeerItems {
	...
	public static final Item SOLID_GOLD_DEER_ARTIFACT = register("solid_gold_deer_artifact", new SolidGoldDeerArtifactItem(new Item.Settings().maxCount(1).rarity(Rarity.UNCOMMON)));
