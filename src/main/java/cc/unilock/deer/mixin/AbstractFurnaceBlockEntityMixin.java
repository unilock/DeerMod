...
public class AbstractFurnaceBlockEntityMixin {
	...
	private static void craftRecipe$decrement(ItemStack instance, int amount, Operation<Void> original, DynamicRegistryManager registryManager, @Nullable RecipeEntry<?> recipe, DefaultedList<ItemStack> slots, int count) {
